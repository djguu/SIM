...
<section class="home_part">
    <div class="container min-vh-100 row align-items-center mx-auto">
        ...
        if(isset($_GET["delete"])){
            include($_SERVER['DOCUMENT_ROOT'] . '/assets/php/videos/videos_delete.php');
        }
        elseif(isset($_GET["add"])){
            include($_SERVER['DOCUMENT_ROOT'] . '/assets/php/videos/videos_add.php');
        }
        elseif(!isset($_GET["add"])){
            include($_SERVER['DOCUMENT_ROOT'] . '/assets/php/videos/videos_list.php');
        }
        ?>
    </div>
</section>
